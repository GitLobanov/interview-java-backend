## [[../Storage/Kafka Producer]]

## [[../Storage/Kafka Consumer]]

## [[../Storage/Log Segments Kafka]]

## [[../Storage/Kafka Streams]]

# Resources

- [Apache Kafka](https://backendinterview.ru/db/messages/kafka.html#apache-kafka)
- [Apache Kafka: разбираемся в технологии в теории и на практике](https://selectel.ru/blog/apache-kafka-2/)
...
- [5 вещей о которых должен знать каждый разработчик Apache Kafka](https://habr.com/ru/companies/slurm/articles/547264/)
...
- [Как Apache Kafka поддерживает 200К партиций в кластере?](https://habr.com/ru/company/southbridge/blog/544958/)
- [RedPanda Understanding Apache Kafka](https://www.redpanda.com/guides/kafka-tutorial-kafka-partition-strategy)
- [Arenadata Streaming](https://docs.arenadata.io/ru/ADStreaming/current/concept/architecture/kafka/storage_concepts.html)
- 