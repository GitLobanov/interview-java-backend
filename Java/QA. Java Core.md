...
21. Как обеспечивается параллельное выполнение в стрим апи, при помощи ForkJoinPool
...
107. Что такое immutable класс в Java?  Как создать? 

- [[Immutable Class]]

111. Что такое автоупаковка (autoboxing) и автораспаковка (unboxing) в Java?  
