...
#### Разница внедрения через поле и конструктор
...
#### акие существуют способы передачи пропертей в Spring?
...
#### Для чего используется аннотация @Lazy при self-injection в Spring?
