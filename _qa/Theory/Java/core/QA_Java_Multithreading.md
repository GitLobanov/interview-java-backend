...
#### Как работает ThreadPoolExecutor и какие у него основные параметры?
...
#### В чем разница между ReentrantLock и ReentrantReadWriteLock?
